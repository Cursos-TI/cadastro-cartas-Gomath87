...
int main() {
  ...
  // Área para exibição dos dados da cidade
    ...
    case 5: // DENSIDADE DEMOGRÁFICA (Regra Invertida!)
        ...
        printf("%s: %.2f hab/km²\n", cidade1, calculoDensidade1);
        printf("%s: %.2f hab/km²\n", cidade2, calculoDensidade2);
        
        // ATENÇÃO: Aqui o MENOR (<) vence!
    ...
    default:// Proteção caso o usuário digite um número errado (Requisito Não Funcional)
